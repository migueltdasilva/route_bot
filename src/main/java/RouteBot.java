...
public class RouteBot extends Bot {
    ...
    private static final String[] vTrips =
            new String[] {"Хочу в сейлить в Гелике! 15-18 апреля"};
    ...
    static {
        vQuestions[0] = new String[]{
                ...
                "Тест на яхтсмена: объясни, почему трепещет колдунчик. Не гуглить!",

                "Волна 2 метра – это страх или восторг?",
                ...
                "Представь, что ты только что первым пересек финишную линию и" +
                    " победил в регате, запиши набор своих победных звуков-эмоций в формате аудиосообщения."};
