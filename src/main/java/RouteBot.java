...
public class RouteBot extends Bot {
    ...
    private static final String[] vTrips =
            new String[] { "Хочу чил и экстрим в Красной поляне! 23-25 апреля", "Хочу в Киргизию! 5-10 мая"};
    ...
    static {
        ...
        vQuestions[1] = new String[]{
                ...
                "Вспомни свою встречу с самым пугающим животным, кто это? " +
                    "Изобрази его звуком в аудиосообщении, а мы попробуем угадать!"};
