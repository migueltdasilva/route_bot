...
//
//                "В этой поездке мы попросим вас много думать и придумывать. Есть ли что-то, что ты любишь делать руками?",
//
...
//
//                "На базе в Дальних Зеленцах можно будет подайвить. " +
//                "Как тебе идея опуститься на дно Баренцева моря? " +
